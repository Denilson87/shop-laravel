            ...
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                    <a href="{{route('admin.Brands')}}"> < Voltar a lista das Marcas</a>
                    <br><br>
                      ...
                      {{csrf_field()}}
                        ...
                        <div class="form-group">
                          ...
                          <textarea type="textarea" class="form-control" id="Type" name="Type" >{{$Brands->type}}</textarea>
                        </div>
